...
const ContactSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    playSuccess();
    const phoneNumber = "+917635817916";
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText("koushtavboruah6@gmail.com");
    playPop();
    setCopied(true);
        ...
        <div className="space-y-8 md:space-y-10">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 p-4 border border-foreground/10 bg-white/50 hover:border-black transition-colors duration-300">
              ...
              <div>
                ...
                <p className="font-mono text-sm">+91 7635817916</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              {[
                { Icon: Github, href: "https://github.com/koushtavboruah6-design" },
                { Icon: Linkedin, href: "https://www.linkedin.com/in/koushtav-boruah-139929371?utm_source=share_via&utm_content=profile&utm_medium=member_android" },
                {
                  Icon: BookOpen,
                  href: "https://koushtavboruah.hashnode.dev/",
                },
              ].map(({ Icon, href }, i) => (
                <a
                  key={i}
